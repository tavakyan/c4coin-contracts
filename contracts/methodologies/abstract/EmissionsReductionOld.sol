...
import "../interfaces/IAdditionalityOld.sol";
import "../interfaces/IEmissionsOld.sol";
import "../interfaces/IEmissionsReductionOld.sol";


contract EmissionsReductionOld is IEmissionsReductionOld {

    IEmissionsOld internal baseline;
    IEmissionsOld internal project;
    IEmissionsOld internal leakage;
    IAdditionalityOld internal additionality;

    constructor(
        IAdditionalityOld _additionality,
        IEmissionsOld _baseline,
        IEmissionsOld _project,
        IEmissionsOld _leakage) {
